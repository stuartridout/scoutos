...
export default function SupportPage() {
  // Only products that have their own help/FAQs pages yet (flip the flag in
  // lib/products.ts when HikeCheck / Waitlist ship theirs).
  const withSupport = products.filter((p) => p.hasOwnSupport);
  return (
    <>
      <Nav />
      <main>
        ...
        <section style={{ padding: '40px 0' }}>
          <div className="container" style={{ maxWidth: 860 }}>
            ...
            <p style={{ marginTop: 10, fontSize: 16, lineHeight: 1.6, color: 'var(--ink-2)', maxWidth: 620 }}>
              Some tools keep their own help pages and FAQs — the fastest answer is usually there:
            </p>
        ...
        {/* Still stuck — contact ScoutOS (white, sits under the product help) */}
          ...
          <div className="container" style={{ maxWidth: 860 }}>
            ...
            >
              ...
              <p style={{ marginTop: 12, fontSize: 16, lineHeight: 1.6, color: 'var(--ink-2)', maxWidth: 620 }}>
                If your question is about ScoutOS as a whole — or about a tool that doesn’t have its own help
                pages yet — email us and a volunteer will get back to you. We’re {developer.name}; please bear
                with us, we run this alongside everything else Scouting asks of us.
              </p>
              <a
